        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            <h1 className="text-5xl font-bold mb-6">
              About <span className="text-[#F37021]">Alfrexco</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-[#1A1A1A] mb-6">
                The Alfrexco Experience
              </h2>
              <div className="space-y-4 text-gray-600">
                <p>
                  With Alfrexco as your exclusive data solutions and verification partner, 
      ...
      <section className="py-20 bg-[#1A1A1A] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Experience the Alfrexco difference and transform your data strategy.
          </p>
          <a
            href="/contact"
